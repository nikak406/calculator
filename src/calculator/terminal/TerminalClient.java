...
public class TerminalClient {
	...
	public static void main(String[] args){
		String WELCOME_MESSAGE = "Welcome to Calculator terminal client\n"
				+ "Type \"help\" for help or \"exit\" for exit.\n"
				+ "\u00A9 Eugene Savochkin, 2015";
		String HELP_MESSAGE = "Just type an equation you need to compute and press ENTER, e.g. '2+2'. +-*/^ are allowed operators.\n"
